...
class CustumersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create custumer" do
    assert_difference('Custumer.count') do
      post custumers_url, params: { custumer: { cpf: @custumer.cpf, custumer: @custumer.custumer, email: @custumer.email, phone: @custumer.phone } }
    end
  ...
  test "should update custumer" do
    patch custumer_url(@custumer), params: { custumer: { cpf: @custumer.cpf, custumer: @custumer.custumer, email: @custumer.email, phone: @custumer.phone } }
